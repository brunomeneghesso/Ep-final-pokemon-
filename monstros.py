...
def coloca_monstros(game):
    ...
    game.inicial_fogo = sprites.Monstro('Agni', [game.fogo], 3, 8, 100, 100, {game.fogo1:0,game.neutro1:0, game.neutro2:7, game.fogo2:15, game.neutro3:30, game.fogo3:45}, pg.image.load(path.join(img_folder, "fire.png")).convert(),pg.image.load(path.join(img_folder, "fire2.png")).convert(), [3,5,10,10],20)
    game.inicial_agua = sprites.Monstro('Nautica', [game.agua], 2, 12, 120, 100, {game.agua1:0,game.neutro1:0, game.neutro2:7, game.agua2:15, game.neutro3:30, game.agua3:45}, pg.image.load(path.join(img_folder, "water.png")).convert(),pg.image.load(path.join(img_folder, "water2.png")).convert(), [2,7,12,8],20)
    game.inicial_planta = sprites.Monstro('Grover', [game.fogo], 1, 16, 150, 100, {game.planta1:0,game.neutro1:0, game.neutro2:7, game.planta2:15, game.neutro3:30, game.planta3:45}, pg.image.load(path.join(img_folder, "leaf.png")).convert(),pg.image.load(path.join(img_folder, "leaf2.png")).convert(), [1,10,15,15],20)